...
<div class="<?php echo esc_attr($atts['class']) ?>" data-shortcode="<?php echo esc_attr($args['shortcode_tag']) ?>">
    <form action="#" method="post">
        ...
        <div class="form-group">
            ...
            <label for="<?php echo $shortcode ?>_input"  class="control-label"><?php esc_html_e("Subject", "mycustomForm") ?></label>
        </div>
        <div class="form-group">
            <input id="<?php echo $shortcode ?>_email"type="text" required value="<?php echo esc_attr($atts['email']) ?> "/>
            <label for="<?php echo $shortcode ?>_email" class="control-label" ><?php esc_html_e("Email", "mycustomForm") ?></label>
        </div>
        <div class="form-group">
